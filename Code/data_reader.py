...
#indicators what data has been loaded
YELLOW_PU = False
YELLOW_DO = False
GREEN_PU = False
GREEN_DO = False
...
empty_data = {
    ...
    'total_trip_count': 0,
    'trips_inside_Location': 0,   
    'trips_outgoing_Location': 0,
    'trips_incoming_Location': 0
    }


def read_parquet_files(year):
    # Folde paths
    yellow_folder = 'C:\\Users\\Mark\\OneDrive\\Documents\\Uni\\Informatik_Master\\Semester_2\\Computergrafik und Informationsvisualisierung\\Seminar\\Data\\drive_data\\Yellow\\'
    green_folder = 'C:\\Users\\Mark\\OneDrive\\Documents\\Uni\\Informatik_Master\\Semester_2\\Computergrafik und Informationsvisualisierung\\Seminar\\Data\\drive_data\\Green\\'
    # Get a list of all files in the folder
    file_list = [file for file in os.listdir(folder_path) if file.endswith('.parquet')]

    # Initialize an empty DataFrame to concatenate all the Parquet files
